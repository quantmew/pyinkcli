...
def createDevtoolsBackendFacade(
    ...
    def dispatch_message(message: dict[str, Any]) -> Any:
        ...
        if message.get("type") == "request":
            ...
            if event == "inspectElement":
                ...
                _sync_selection_state_after_inspect(
                    renderer_interface,
                    state,
    ...
    agent_methods = {
        ...
        "getPersistedSelection": _make_get_persisted_selection_method(state),
        "setPersistedSelection": _make_set_persisted_selection_method(renderer_interface, state),
        "clearPersistedSelection": _make_clear_persisted_selection_method(renderer_interface, state),
        "getPersistedSelectionMatch": _make_get_persisted_selection_match_method(state),
        "setPersistedSelectionMatch": _make_set_persisted_selection_match_method(state),
...
def _make_get_persisted_selection_method(
    state: dict[str, Any],
...
def _make_set_persisted_selection_method(
    renderer_interface: dict[str, Any],
    state: dict[str, Any],
    ...
    def method(selection: dict[str, Any] | None) -> None:
        normalized = _normalize_persisted_selection(selection)
...
def _make_clear_persisted_selection_method(
    renderer_interface: dict[str, Any],
    state: dict[str, Any],
) -> Callable[[], None]:
    def method() -> None:
...
def _make_get_persisted_selection_match_method(
    state: dict[str, Any],
) -> Callable[[], dict[str, Any] | None]:
    def method() -> dict[str, Any] | None:
...
def _make_set_persisted_selection_match_method(
    state: dict[str, Any],
) -> Callable[[dict[str, Any] | None], None]:
    def method(match: dict[str, Any] | None) -> None:
        normalized = _normalize_persisted_selection_match(match)
...
def _normalize_persisted_selection(
...
def _normalize_persisted_selection_match(
...
def _sync_selection_state_after_inspect(
    renderer_interface: dict[str, Any],
    state: dict[str, Any],
    *,
    node_id: Any,
...
def package_version() -> str:
    from pyinkcli.reconciler import packageInfo
